      ...
      <section className='pt-20 pb-16'>
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          <div className='text-center mb-16'>
            <h1 className='text-4xl md:text-6xl font-display font-bold mb-6 text-slate-800'>
              Tech Stack
            </h1>
            ...
            {technologies.map((tech, categoryIndex) => (
              <div key={categoryIndex} className='card p-8'>
                <div className='flex items-center mb-6'>
                  <div className={`w-12 h-12 ${tech.color} rounded-xl flex items-center justify-center border border-slate-200 mr-4`}>
                    {tech.icon}
                  </div>
        ...
        <div className='max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8'>
          ...
          <div className='flex flex-col sm:flex-row gap-4 justify-center'>
            <a
              ...
              className='bg-slate-900 text-white hover:bg-slate-800 font-semibold px-8 py-4 rounded-xl transition-all duration-300 transform hover:scale-105 hover:shadow-lg flex items-center justify-center space-x-2'
            >
